            ...
            <>
              ...
              {activeTab === 'general' && (
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-3">
                    <Button variant="minimal" onClick={() => resetToDefaults('general')}>Reset to Defaults</Button>
              ...
              {activeTab === 'email' && (
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-3">
                    <Button variant="minimal" onClick={() => resetToDefaults('email')}>Reset to Defaults</Button>
              ...
              {activeTab === 'security' && (
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-3">
                    <Button variant="minimal" onClick={() => resetToDefaults('security')}>Reset to Defaults</Button>
