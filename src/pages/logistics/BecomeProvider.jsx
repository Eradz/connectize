      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-4">
            Do not have an account? <Link to="/signup" className="text-blue-600 dark:text-blue-400 hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    );
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {SERVICE_TYPES.map(service => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-6 h-6 mb-2 ${isSelected ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500'}`} />
