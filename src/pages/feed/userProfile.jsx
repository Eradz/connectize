                  ...
                  <div className="flex gap-2 lg:gap-8 min-w-min">
                    {[
                      ...
                      <button
                        ...
                        className={`pb-4 px-2 font-medium text-sm transition-all ${activeTab === tab.id
                    ...
                    <div className="border-b mb-6">
                      <div className="flex gap-4">
                        <button
                          ...
                          className={`pb-3 px-1 font-medium text-sm transition-all ${activeEventTab === 'created'
                              ? 'text-gray-900 border-b-2 border-gold'
                              : 'text-gray-600 hover:text-gray-900 border-b-2 border-transparent'
                            }`}
                        >
                        ...
                        {<button
                          ...
                          className={`pb-3 px-1 font-medium text-sm transition-all ${activeEventTab === 'registered'
                              ? 'text-gray-900 border-b-2 border-gold'
                              : 'text-gray-600 hover:text-gray-900 border-b-2 border-transparent'
                            }`}
                        >
                    ...
                    <div className="border-b mb-6">
                      <div className="flex gap-4">
                        <button
                          ...
                          className={`pb-3 px-1 font-medium text-sm transition-all ${activeJobTab === 'created'
                              ? 'text-gray-900 border-b-2 border-gold'
                              : 'text-gray-600 hover:text-gray-900 border-b-2 border-transparent'
                            }`}
                        >
                        ...
                        {currentUser?.id == userId && (<button
                          ...
                          className={`pb-3 px-1 font-medium text-sm transition-all ${activeJobTab === 'applied'
                              ? 'text-gray-900 border-b-2 border-gold'
                              : 'text-gray-600 hover:text-gray-900 border-b-2 border-transparent'
                            }`}
                        >
                    ...
                    <div className="border-b mb-6">
                      <div className="flex gap-4">
                        <button
                          ...
                          className={`pb-3 px-1 font-medium text-sm transition-all ${activeDealTab === 'created'
                              ? 'text-gray-900 border-b-2 border-gold'
                              : 'text-gray-600 hover:text-gray-900 border-b-2 border-transparent'
                            }`}
                        >
                        ...
                        {currentUser?.id === Number(userId) && <button
                          ...
                          className={`pb-3 px-1 font-medium text-sm transition-all ${activeDealTab === 'participating'
                              ? 'text-gray-900 border-b-2 border-gold'
                              : 'text-gray-600 hover:text-gray-900 border-b-2 border-transparent'
                            }`}
                        >
