...
export const meta = () =>
  createSEO({
    title: "My Posted Jobs | Connectize",
    description: "Manage the job openings you have posted on Connectize. Review applications and track hiring progress.",
  keywords: "my jobs, posted jobs, job management, recruitment, Connectize",
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-row items-end md:items-center justify-between">
            ...
            <div className="mt-4 sm:mt-0">
              <Link
                ...
                className="inline-flex items-center px-4 py-2 bg-pale_yellow text-dark rounded-lg hover:bg-gold transition-colors"
              >
          ...
          {filteredJobs.length === 0 ? (
            <div className="bg-white rounded-lg shadow-sm p-12 text-center">
              ...
              {!searchTerm && filterStatus === 'all' && (
                <Link
                  to={webRoutes.workforceJobCreate}
                  className="inline-flex items-center px-4 py-2 bg-gold text-dark rounded-lg hover:bg-gold/70 transition-colors"
                >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
              {filteredJobs.map((job) => (
                <JobCard key={job.id} job={job} myPostedJob={true} setShowDeleteModal={setShowDeleteModal} setJobToDelete={setJobToDelete} />
              ))}
        </div>
            </div>
          )}
