                  ...
                  {isJobPoster ? (
                    <>
                      ...
                      <button
                        ...
                        className="flex items-center justify-center rounded-lg bg-gold p-2 font-medium text-dark transition-colors hover:bg-custom_yellow disabled:cursor-not-allowed disabled:opacity-50"
                      >
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="flex items-center justify-center rounded-lg bg-gold p-2 font-medium text-dark transition-colors hover:bg-custom_yellow"
                      >
