...
export const meta = () =>
  createSEO({
    title: "Update Profile | Connectize",
    description: "Update your Connectize professional profile details including name and headline.",
  keywords: "update profile, professional details, Connectize",
  });
