  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {sortedProviders.map((provider, pIdx) => {
      ...
      <button
        ...
        className="w-full px-6 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-lg font-medium transition-colors"
      >
        {loading ? (
          <>
