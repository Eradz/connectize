...
const DealRooms = () => {
  ...
  return (
    <div className="min-h-screen ">
      ...
      {/* NAVIGATION TABS */}
      <div className="md:hidden max-w-7xl mx-auto px-4 py-4 border-b border-gray-200">
        <div className="flex gap-4">
          <Link
            to={webRoutes.dealRooms}
            className="px-6 py-2 text-sm font-medium text-gray-900 border-b-2 border-[#FFD700] hover:text-gray-700"
          >
            All Deal Rooms
          </Link>
          <Link
            to={webRoutes.myParticipations}
            className="px-6 py-2 text-sm font-medium text-gray-600 border-b-2 border-transparent hover:text-gray-900 hover:border-gray-300"
          >
            My Participations
          </Link>
        </div>
